...
[SPANISH] = " !#$%&'()*+,-.0123456789:<=>@ABCDEFGHIJKLMNOPQRSTUVWXYZ^_abcdefghijklmnopqrstuvwxyzé←↑↵◆●☆♀♂✖✧🟊",
[KOREAN] = " !#$%&'()*+,-.0123456789:<=>@ABCDEFGHIJKLMNOPQRSTUVWXYZ^_abcdefghijklmnopqrstuvwxyzé←↑↵◆●☆♀♂✖✧🟊",
[CHINESE_SIMPLIFIED] = " !#$%&'()*+,-.0123456789:<=>@ABCDEFGHIJKLMNOPQRSTUVWXYZ^_abcdefghijklmnopqrstuvwxyzé←↑↵◆●☆♀♂✖✧🟊",
[CHINESE] = " !#$%&'()*+,-.0123456789:<=>@ABCDEFGHIJKLMNOPQRSTUVWXYZ^_abcdefghijklmnopqrstuvwxyzé←↑↵◆●☆♀♂✖✧🟊"
